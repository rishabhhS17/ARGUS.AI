    ...
    <div className="flex h-screen w-screen overflow-hidden flex-col-reverse md:flex-row bg-slate-950">
      ...
      <nav className="w-full h-16 md:w-16 md:h-full bg-slate-900 border-t md:border-t-0 md:border-r border-slate-800 flex flex-row md:flex-col items-center justify-around md:justify-start py-0 md:py-6 gap-0 md:gap-6 z-50 shrink-0">
        ...
        <NavLink 
          ...
          title="Dashboard"
          className={({ isActive }) => 
            `p-3 rounded-xl transition ${isActive ? 'bg-cyan-900/50 text-cyan-400' : 'text-slate-500 hover:bg-slate-800'}`
          }
        >
        ...
        <NavLink 
          ...
          title="Add Units"
          className={({ isActive }) => 
            `p-3 rounded-xl transition ${isActive ? 'bg-emerald-900/50 text-emerald-400' : 'text-slate-500 hover:bg-slate-800'}`
          }
        >
        ...
        <NavLink 
          ...
          className={({ isActive }) => 
            `p-3 rounded-xl transition ${isActive ? 'bg-blue-900/50 text-blue-400' : 'text-slate-500 hover:bg-slate-800'}`
          }
        >
        ...
        <NavLink 
          ...
          className={({ isActive }) => 
            `p-3 rounded-xl transition ${isActive ? 'bg-red-900/50 text-red-400' : 'text-slate-500 hover:bg-slate-800'}`
          }
        >
